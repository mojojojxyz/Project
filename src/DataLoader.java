...
public class DataLoader {
        ...
        public static DecisionTree loadInitialTree() {
                ...
                // L6 YES
                // L7
                Node l7_responsive = new Node("Are you interested in creating responsive, accessible web interfaces?");
                l6_frameworks.setYesNode(l7_responsive);

                // L7 YES
                // L8
                Node l8_clientOnly = new Node(
                ...
                // L7 NO
                // L8
                Node l8_backend = new Node(
                                "Do you prefer writing server-side APIs and business logic over working with databases directly?");
                ...
                // L6 NO -> Mobile path
                // L7
                Node l7_mobile = new Node(
                                "Do you enjoy building native apps using platform-specific tools (Swift for iOS, Kotlin for Android)?");
                ...
                // L6
                Node l6_mobileAlt = new Node("Do you like to develop apps for smartphones and tablets?");
                ...
                // L6
                Node l6_bi = new Node(
                                "Do you like to build dashboards and data visualizations for business decision-making?");
                ...
                // L5 YES
                // L6
                Node l6_mlprod = new Node(
                                "Do you like to optimize ML pipelines using frameworks like TensorFlow, PyTorch, or MLflow?");
                ...
                // L6
                Node l6_ds = new Node(
                                "Do you enjoy using Python, R, or SQL to analyze datasets and create statistical models?");
                ...
                // L3 NO: Not DevOps → Backend/API path
                // L4
                ...
                // L4 YES
                // L5
                Node l5_devops = new Node(
                                "Do you like working with cloud infrastructure using tools like Terraform, Ansible, or CloudFormation?");
                ...
                // L5 YES
                // L6
                Node l6_auto = new Node(
                                "Do you like to write automation to reduce toil and prevent recurring outages?");
                l5_slo.setYesNode(l6_auto);

                // L6 YES
                // L7
                Node l7_observ = new Node(
                                "Do you enjoy building observability systems with metrics, logs, and distributed tracing?");
                ...
                // L7 YES
                // L8
                Node l8_iac = new Node(
                                "Do you like provisioning resources using Infrastructure as Code (Terraform, CloudFormation)?");
                ...
                // L4 NO: Not security → Cloud/Network
                // L5
                ...
                // L6 YES
                // L7
                Node l7_redteam = new Node(
                                "Do you like to conduct red team operations and social engineering assessments?");
                ...
                // L5 YES
                // L6
                Node l6_iotCloud = new Node(
                                "Do you enjoy integrating IoT devices with cloud platforms for data collection and monitoring?");
                ...
                // L5 YES
                // L6
                Node l6_chip = new Node("Do you enjoy designing at the chip or FPGA level rather than board level?");
                ...
                Node l5_hwLast = new Node(
                                "Do you like towrite low-level firmware for microcontrollers and embedded devices?");
